<head>
    ...
    <script type="text/javascript" src="<?php echo base_url('public/js/pool.js'); ?>"></script>
    <script type="text/javascript" src="<?php echo base_url('public/js/resume.js'); ?>"></script>
